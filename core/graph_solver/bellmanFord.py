...
def run_bellman(donnees):
    try:
        ...
        longueur = nx.bellman_ford_path_length(G, source=depart, target=arrivee, weight='weight')
        chemin = nx.bellman_ford_path(G, source=depart, target=arrivee, weight='weight')
        ...
        message_resultat = "Bellman-Ford : Plus court chemin de " + str(depart) + " à " + str(arrivee) + " est " + chemin_str + " (Coût: " + str(longueur) + ")"
        ...
        return {"succes": False, "message": "Bellman-Ford : Aucun chemin entre " + str(depart) + " et " + str(arrivee) + "."}
    except Exception as e:
        return {"succes": False, "message": "Erreur dans Bellman-Ford: " + str(e)}